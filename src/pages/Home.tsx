 ...
 *   MockTradeArena -> the app's display name
 *   매일 가상자금으로 모의매매를 하고 내 포트폴리오를 과거 데이터로 백테스트해보는 투자연습 미니앱    -> the one-line description
 */
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <SummaryHero
        label="MockTradeArena"
        value={<Paragraph.Text typography="t2">매일 가상자금으로 모의매매를 하고 내 포트폴리오를 과거 데이터로 백테스트해보는 투자연습 미니앱</Paragraph.Text>}
